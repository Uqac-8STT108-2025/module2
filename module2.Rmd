...
#le dataset 1 est enregistre sous la variable vehicule. On l'a deja chargee dans le chunck 'r dataset'
#plus haut.

extreme_vehicule <- vehicule

df_numeriques <- vehicule %>%
  select_if(is.numeric)  # Sélection des colonnes numériques
head(df_numeriques)

```

Il faut répondre a la question sur les colonnes de df_numeriques
